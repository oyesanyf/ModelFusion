...
Write-Host "[BUILD] Starting HugOS IDE build watch loop in a separate window..." -ForegroundColor Yellow
...
Write-Host "[RUN] Launching HugOS IDE..." -ForegroundColor Green
& .\scripts\code.bat
