...
const native = process.platform === 'win32' ? (() => { try { return require('../build/Release/windows_process_tree.node'); } catch(e) { return undefined; } })() : undefined;
var ProcessDataFlag;
...
(function (getAllProcesses) {
    // tslint:disable-next-line:variable-name
    getAllProcesses.__promisify__ = (flags) => new Promise((resolve, reject) => {
        getAllProcesses((processList) => resolve(processList), flags);
    });
})(getAllProcesses = exports.getAllProcesses || (exports.getAllProcesses = {}));
...
[getProcessTree, getProcessList, getProcessCpuUsage, getAllProcesses].forEach(func => Object.defineProperty(func, util_1.promisify.custom, { enumerable: false, value: func.__promisify__ }));//# sourceMappingURL=https://main.vscode-cdn.net/sourcemaps/9245b533dbbd1141f956584d2ef044beec135d20/node_modules/@vscode/windows-process-tree/lib/index.js.map