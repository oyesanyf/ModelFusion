...
UNMINIFIED_BLOCK = r'''
    ...
    const knownCommands = /* @__PURE__ */ new Set([
      ...
      "codevulnerabilitydetection","fix","edit","review","explain","tests","refactor","audit","optimize","generate",
