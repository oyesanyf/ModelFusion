...
UNMINIFIED_BLOCK = r'''
    ...
    const knownCommands = /* @__PURE__ */ new Set([
      ...
      "active-model","active-models","current-model","current-models","ide-model","models-in-use","version","updatedb",
    ...
    const normCmd = (cmd) => {
      ...
      if (l === "active-models" || l === "current-model" || l === "current-models" || l === "ide-model" || l === "models-in-use") return "active-model";
