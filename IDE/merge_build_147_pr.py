...
BRANCH = "feat/docs-and-doctest-build-147"
...
def main():
    ...
    commit_msg = "feat(docs): upgrade README with interactive architecture, fix atlas doc-test, package signed MSI 147"
    ...
    pr_data = {
        "title": commit_msg,
        "body": "## Summary\n- Upgrade README with interactive architecture diagrams and enhanced multi-modal documentation\n- Fix ATLASThreatDetector doc-test in `crates/security/src/atlas.rs`\n- Build and package Authenticode-signed HugOS MSI Build 147 with DigiCert timestamping\n- Maintain 4-way cryptographic binary parity across all distribution targets",
        "head": BRANCH,
        "base": "main"
    }
    headers = {
