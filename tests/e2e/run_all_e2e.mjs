// run_all_e2e.mjs - Master Standalone Test Runner for ModelFusion & HugOS IDE 19-Feature 4-Tier E2E Tests
...
const testFiles = [
    'tier1_features.test.mjs',
    'tier2_boundaries.test.mjs',
    'tier3_interactions.test.mjs',
    'tier4_scenarios.test.mjs'
];
...
async function runTests() {
    ...
    const files = testFiles.map(f => path.join(__dirname, f));
